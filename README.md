...
The Report Q&A Agent has started with a deterministic Markdown ingestion, keyword-retrieval, cited extractive-answer workflow, and an offline evaluation question set for citation checks.
