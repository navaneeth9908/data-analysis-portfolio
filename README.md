...
The Research Briefing Generator now provides a deterministic local JSON source-note contract, transparent source ranking with an explicit reporting date, publisher-coverage and freshness-band summaries, source-coverage notes for thin or concentrated evidence, Markdown and self-contained HTML digest output with linked evidence and follow-up questions, a bundled sample, and end-to-end CLI tests.
