...
The Report Q&A Agent has started with deterministic Markdown/plain-text/PDF ingestion, keyword retrieval, cited extractive-answer workflow, Markdown brief export, and an offline evaluation question set for citation checks.
