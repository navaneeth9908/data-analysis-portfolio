...
""".strip(),
        ...
        {
            "difficulty": "advanced",
            "question": "Show quarter over quarter revenue growth by region for 2024",
            "sql": """
...
""".strip(),
        ...
        {
            "difficulty": "advanced",
            "question": "How does product category revenue mix vary by customer segment?",
            "sql": """
...
""".strip(),
        ...
        {
            "difficulty": "advanced",
            "question": "Which customer segments have the highest software revenue share?",
            "sql": """
WITH segment_category_revenue AS (
    SELECT c.segment,
           ROUND(SUM(oi.quantity * oi.unit_price), 2) AS total_revenue,
...
""".strip(),
        ...
        {
            "difficulty": "advanced",
            "question": "Which customers received the largest discounts?",
            "sql": """
SELECT c.customer_name,
       c.region,
       ROUND(SUM((p.list_price - oi.unit_price) * oi.quantity), 2) AS discount_amount,
