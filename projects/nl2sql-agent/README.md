...
The demo builds the SQLite mart if needed, generates a safe SQL query, validates table and column references, executes the query in read-only mode, adds a deterministic business-facing answer summary, and prints an interview-friendly result table. The offline fallback currently covers revenue-by-region, top-products-by-revenue, product units-sold ranking, average selling price by product, monthly revenue trend, month-over-month revenue growth, quarter-over-quarter revenue growth, regional quarter-over-quarter revenue growth, product-level quarter-over-quarter growth, customer-segment quarter-over-quarter growth, quarterly revenue by region, top-customers-by-revenue, customer revenue concentration, cross-category customer adoption, repeat-customer detection, repeat-customer regional concentration, repeat-customer rate by region, regional product-mix breadth, customer-segment product-mix breadth, customer-segment revenue mix, customer-segment category revenue mix, customer-segment software revenue-share ranking, customer-segment discount analysis, customer-level discount analysis, regional discount exposure, product-category revenue mix, category revenue-share contribution, regional category revenue mix, regional software-revenue mix, regional services-revenue mix, top product by region, segment average-order-value, region average-order-value, below-list-price discount analysis, product discount-rate analysis, and product co-purchase affinity questions.
